                ...
                <div class="card p-4 border rounded mb-5">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4">
                            <a class="text-decoration-underline text-sm text-gray-600 hover:text-gray-900" href="{{ route('login') }}">
    ...
    <footer class="footer p-5" style="background-color: #212e77;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 text-light">
                    <h5>Tentang Kami</h5>
                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Cupiditate cum molestiae aliquam illo provident id.</p>
                </div>
                <div class="col-md-3 text-light">
                    <h5>Kontak</h5>
