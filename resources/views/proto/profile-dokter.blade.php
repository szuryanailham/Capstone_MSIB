    ...
    <section>
        ...
        <div class="container mt-5 mb-5">
            <div class="d-flex flex-row justify-content-center">
                <div class="card">
                    <img src="/asset/Rectangle 20.png " alt="img">
                </div>
                <div class="card ms-3 px-3 py-3 text-center " style="background-color: #D9D9D9; width: 30%;">
                    <br><br><br>
                    <h5> Dr.h.Rangga Nugraha S.Pd, M.Pd</h5>
                    <p>Spesialis Kelamin</p>
                    <h6>Jadwal Praktik</h6>
                    <p class="lh-base">Senin : 08.30 - 10.30 <br>Rabu : 09.30 - 14.30 <br>Kamis : 11.30 - 17.30</p><br
                        <a href="#"><button type="button" class="btn btn-danger w-100">kembali</button></a>
                </div>
            </div>
    </section>
    <!-- hero section end -->
