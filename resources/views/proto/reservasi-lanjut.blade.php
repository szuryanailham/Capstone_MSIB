                ...
                <form method="POST" class="form">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control clr-input" id="namapasien"
                            placeholder="silahkan anda memilih dokter">
                    </div>

                    <div class="mb-3">
                        <label class="form-label fw-semibold">Tanggal Periksa</label>
                        <input type="date" class="form-control clr-input" id="alamat"
                            placeholder="silahkan masukan tanggal periksa">
                    </div>


                    <div class="form-text text-danger fw-semibold mb-2">*) Wajib diisi</div>
                    <div class="d-flex justify-content-between">
                        <a href="/reservasi/reservasi.html"> <button type="button"
                                class="btn btn-danger py-1 ">Kembali</button></a>
                        <a href="/reservasi/reservasi-pembayaran.html"><button type="button"
