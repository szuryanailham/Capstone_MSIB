            ...
            <div class="row justify-content-center mt-5 rounded">
                <div class="col-md-4 mb-5">
                    <div class="text-center mb-4">
                        <h5>Silahkan Masukan Tanggal Periksa Anda</h5>
                    </div>
                    <form method="POST" class="form">
                        <div class="mb-3">
                            ...
                            <p class="fw-semibold mt-2 mb-4">*Masukan Tanggal Periksa Anda dengan Benar</p>
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="/reservasi/reservasi-lanjut.html"><button type="button"
                                    class="btn btn-primary py-1 ">Cetak</button></a>
                        </div>
                    </form>
                </div>
            </div>
