            ...
            <div class="row justify-content-center mt-5 rounded">
                <div class="col-md-4 mb-5">
                    <form method="POST" class="form">
                        <div class="mb-3">
                            <label class="form-label fw-bold">Resep Dokter</label>
                            <div class="card text-center clr-input" style="height: 140px;">
                                <p class="mt-5">keterangan</p>
                            </div>
                            <p class="fw-semibold">*Periksa dengan Teliti resep dokter yang telah di berikan </p>
                        </div>


                        <div class="d-flex justify-content-end">
                            <a href="/reservasi/reservasi-lanjut.html"><button type="button"
                                    class="btn btn-primary py-1 ">selesai</button></a>
                        </div>
                    </form>
                </div>
            </div>
